...
public class JadeGeneralBook implements GeneralBook {
	String[] names;
	String[] records;

	public JadeGeneralBook(String[] names, String[] records) {
		this.names = names;
	...
	public static void main(String[] args) {
		...
		JadeGeneralBook gb = new JadeGeneralBook(names, records);
